									...
									<form method="post" action="submit.php">
										<div class="fields">
											...
											<div class="field third">
													...
													<select name="dateofbirth" id="dateofbirth" required>
											...
											<div class="field third">
												...
												<select name="monthofbirth" id="monthofbirth" required>
											...
											<div class="field quarter">
												<label for="bundling">Code Bundling</label>
												<input type="text" name="bundlingcode" id="bundlingcode" placeholder="Leave blank if there is none"/>
											</div>
